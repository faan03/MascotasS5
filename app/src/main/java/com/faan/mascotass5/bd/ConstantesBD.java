...
public class ConstantesBD {
    public final static String DATABASE_NAME = "BDMascotas";
    public final static int DATABASE_VERSION = 1;

    public final static String TABLE_MASCOTA = "tmascota";
    ...
    public final static String TABLE_LIKES_MASCOTA = "tlikes";
